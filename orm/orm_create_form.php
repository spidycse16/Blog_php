...
<body>
  ...
  <form action="../orm/check.php" method="post" enctype="multipart/form-data">
    ...
    <label for="writer">Post type:</label>
    ...
    <input type="hidden" name="who_posted" value="<?php echo $_SESSION['user_id']; ?>">
